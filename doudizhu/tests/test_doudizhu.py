...
class TestDoudizhu(unittest.TestCase):
    ...
    def test_enum_consistency(self):
        for ct in Doudizhu.CARD_TYPE:
            first_rst = ct['func']()
            self.assertEqual(len(first_rst), ct['size'])
            for i in range(3):
                rst = ct['func']()
                self.assertEqual(rst, first_rst)
    ...
    def test_list_all_gt_cards(self):
        ...
        test_cases = [
            ...
            ('CJ', '2-2-BJ', {}),
            ('J-Q-Q-Q', '2-2-2-2-3-BJ', {'trio_solo': ['3-2-2-2', '2-2-2-BJ'], 'bomb': ['2-2-2-2']}),
            ...
            ('7-7-7-8-8-8-9-9-9-10-10-10', 'J-J-J-Q-Q-Q-K-K-K-A-A-A-3-3-3-Q-3', {'trio_chain_4': ['J-J-J-Q-Q-Q-K-K-K-A-A-A'], 'trio_solo_chain_3': ['3-3-3-J-J-J-Q-Q-Q-K-K-K', '3-3-J-J-J-Q-Q-Q-K-K-K-A', '3-J-J-J-Q-Q-Q-K-K-K-A-A', 'J-J-J-Q-Q-Q-K-K-K-A-A-A', '3-3-3-Q-Q-Q-K-K-K-A-A-A', '3-3-J-Q-Q-Q-K-K-K-A-A-A', '3-J-J-Q-Q-Q-K-K-K-A-A-A'], 'bomb': ['3-3-3-3', 'Q-Q-Q-Q']}),
